...
import { type ComposerBinding } from './DropRail.tsx';
 ...
 * @returns the bridge.
 */
export declare function imageIntakeBridge(): ImageIntakeBridge;
/**
 ...
 * @returns the bridge.
 */
export declare function composerBridge(): ComposerBridge;
/**
 ...
 */
export declare function installPreviewRail(ctx: ClientContext, store: PreviewStore, images: ImageIntakeBridge, composer: ComposerBridge, attached: AttachedFiles): void;
